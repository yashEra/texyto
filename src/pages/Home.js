  ...
  return (
    <div className="App">        <Navbar />
      ...
      <div className="about__welcome">
        <div className="about__welcomeText">
          <div className="about__text">
            <h1>Texyto Provides</h1>
            <h4>Innovative Solutions for Your Business Needs</h4>
            <p>
              Texyto is a leading provider of information technology services
              that cater to a wide range of business needs. We specialize in web
              ...
              team of dedicated experts, we are committed to delivering
              innovative and customized solutions that are tailored to meet the
              unique needs of our clients. At Texyto, we believe that technology
              should be accessible to everyone, and we are passionate about
              helping businesses leverage the power of technology to achieve
              their goals. Whether you're looking to create a stunning website,
              improve your online visibility, or expand your digital
              capabilities, Texyto has the tools and expertise to help you
              transform your tech and succeed in today's competitive
              marketplace.
            </p>
          </div>
